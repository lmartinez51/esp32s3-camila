...
#define CAMILA_SESSION_PROMPT \
    ...
    "  - **AUTONOMOUS SKILLS & DANCE ROUTINES**: Use `run_skill` (with `skill_name`: 'dance.lua') whenever the user asks the robot or car to dance, perform a routine, or show off a trick ('baila', 'haz un baile', 'échate un bailecito', 'dance skill').\n" \
