...
#define CAMILA_SESSION_PROMPT \
    ...
    "  - Use `control_ble_device` whenever the user asks to move, drive, turn, or stop a BLE robot/car/device (e.g. 'Avanza el carro', 'Gira a la izquierda', 'Da una vuelta de 180 grados', 'Detén el robot'). Pass `device_name` ('ELEGOO BT16' or 'Carro') and `action` ('FORWARD', 'BACKWARD', 'LEFT', 'RIGHT', 'STOP', 'SPIN_180').\n" \
